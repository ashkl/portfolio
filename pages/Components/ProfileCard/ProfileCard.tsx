import { Badge, Button, Heading, Stack, Text, Tooltip, useColorModeValue } from "@chakra-ui/react"
        ...
        <>
            <Stack
                ...
                <Stack
                    ...
                    <Text textAlign={'center'} color={useColorModeValue('black', 'white')} px={3}>
                        Software programmer with experience in web application development.
                    </Text>
                    <Stack align={'center'} justify={'center'} direction={'row'} mt={6}>
                        <Badge px={2} py={1} bg={useColorModeValue('gray.200', 'gray.800')} fontWeight={'400'}>
                            #REACT
                        </Badge>
                        <Badge px={2} py={1} bg={useColorModeValue('gray.200', 'gray.800')} fontWeight={'400'}>
                            #Frontend
                    ...
                    <Stack width={'100%'} mt={'2rem'} direction={'row'} padding={2} justifyContent={'space-between'} alignItems={'center'}>
                        <Button flex={1} fontSize={'sm'}
                            borderWidth='1px' rounded={'none'} borderColor={useColorModeValue('black', 'white')}
                            bg={useColorModeValue('white', 'black')}
                            color={useColorModeValue('black', 'white')}
                            _focus={{ bg: `${useColorModeValue('black', 'white')}`, color: `${useColorModeValue('white', 'black')}` }}
                        ...
                        <Tooltip label='Under development' shouldWrapChildren>
                            <Button flex={1} fontSize={'sm'}
                                borderWidth='1px' rounded={'none'} borderColor={useColorModeValue('black', 'white')}
                                bg={useColorModeValue('white', 'black')}
                                color={useColorModeValue('black', 'white')}
